...
xcopy /F /I /Y %STEAMDIR%\Animations\HMG_A.ukx %RELEASEDIR%\Animations\

mkdir %RELEASEDIR%\Sounds 2>nul
xcopy /F /I /Y %STEAMDIR%\Sounds\HMG_S.uax %RELEASEDIR%\Sounds\

REM mkdir %RELEASEDIR%\StaticMeshes 2>nul

mkdir %RELEASEDIR%\Textures 2>nul
xcopy /F /I /Y %STEAMDIR%\Textures\HMG_T.utx %RELEASEDIR%\Textures\
xcopy /F /I /Y %STEAMDIR%\Textures\BDFonts.utx %RELEASEDIR%\Textures\
